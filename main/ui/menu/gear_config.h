...
/**
 * Read every input widget and commit the values to values_config.
 * Call this before saving NVS to ensure the latest typed characters
 * (including "0") are persisted even if no VALUE_CHANGED event fired.
 */
